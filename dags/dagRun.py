...
if database == 'mongoDB':
    ...
    awsIAMrole = 'arn:aws:iam::724611709481:role/service-role/AmazonRedshift-CommandsAccessRole-20220626T122439' 
    ...
    with open(filename, encoding='latin-1') as data:
        ...
        if 'historicalData' in jsonData.keys():
            ...
            if len(dfData) > 0:
                ...
                df.to_csv('/airflow/sparkFiles/parsedData.csv',
                          encoding='utf8',
                          index=False,
                          header=True)
...
def uploadToDB(ti):
    ...
    """
    results = '/airflow/sparkFiles/results.csv'
...
with DAG('analyze_json_data',
    ...
    processParsedData = BashOperator(
        ...
        bash_command='python /airflow/sparkFiles/sparkProcess.py'
    )
