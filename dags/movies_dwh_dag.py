...
params = {'aws_key': 'AKIA2RNRZHIUZ76AKVMS',
          'aws_secret_key': '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',
          'db_user': 'anhlbto',
          'db_pass': 'Lbtanh123',
          'redshift_conn_string': 'jdbc:redshift://redshift-cluster-1.cfu1yuuzougo.ap-southeast-1.redshift.amazonaws.com:5439/dev',
          's3_bucket': 's3a://dataenginnerbucket/udacity-dend/',
          's3_key': 'movie'
         }
...
with DAG(dag_id='movie_dwh_dag', default_args=default_args,
    ...
    create_tables = PostgresOperator(task_id='create-tables',
